 ...
 * @author Elias Kuiter
 */
public abstract class AIntegerList<T extends AIntegerList<?>> implements Comparable<T> {
    protected final int[] integers;
    protected int hashCode;

    public AIntegerList(int... integers) {
    ...
    public AIntegerList(T sortedIntegerList) {
    ...
    public boolean equals(Object obj) {
        ...
        return Arrays.equals(integers, ((AIntegerList<?>) obj).integers);
    }

    @Override
    public int compareTo(AIntegerList other) {
    ...
    public static class DescendingLengthComparator implements Comparator<AIntegerList<?>> {
        @Override
        public int compare(AIntegerList o1, AIntegerList o2) {
            return o2.getIntegers().length - o1.getIntegers().length;
        }
    }

    public static class AscendingLengthComparator implements Comparator<AIntegerList<?>> {
        @Override
        public int compare(AIntegerList o1, AIntegerList o2) {
