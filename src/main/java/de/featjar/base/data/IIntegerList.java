...
public interface IIntegerList extends Supplier<int[]> {
    ...
    static <T> T merge(Collection<? extends IIntegerList> integerLists, Function<int[], T> integerListFactory) {
    ...
    static int[] mergeInt(Collection<int[]> integerLists) {
    ...
    static int[] mergeParallel(Collection<int[]> integerLists) {
