...
public interface IMonitor {
     ...
     * Always called by {@link IMonitorableFunction#apply(Object, IMonitor)}, but can already be called before by the task.
     */
    void setDone();
     ...
     */
    default IMonitor newChildMonitor() {
     ...
     * @return the child monitor
     */
    IMonitor newChildMonitor(int stepsInParent);
}
