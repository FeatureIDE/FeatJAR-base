...
@Deprecated
@FunctionalInterface
public interface IMonitorableFunction<T, R> extends BiFunction<T, IMonitor, Result<R>> {
    /**
     * {@return the result of this monitorable function applied to an input}
     * Performs no sanity checks, call {@link #apply(Object, IMonitor)} instead.
     *
     * @param input the input to the function
     * @param monitor the monitor
     */
    Result<R> execute(T input, IMonitor monitor);
     ...
     */
    @Override
    default Result<R> apply(T input, IMonitor monitor) {
     ...
     */
    default <S> IMonitorableFunction<T, Result<S>> andThen(IMonitorableFunction<R, S> monitorableFunction) {
