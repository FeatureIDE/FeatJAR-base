...
public abstract class AOutput implements IIOObject {
     ...
     * A stream output.
     */
    public static class Stream extends AOutput {
        /**
     ...
     */
    public static class File extends AOutput {
        /**
     ...
     * A string output.
     */
    public static class String extends AOutput {
        /**
     ...
     * Used to create a {@link AOutputMapper.ZIPFile}.
     */
    public static class ZIPEntry extends AOutput {
     ...
     * Used to create a {@link AOutputMapper.JARFile}.
     */
    public static class JAREntry extends AOutput {
        protected final Path path;
