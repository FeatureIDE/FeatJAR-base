...
public abstract class AInputMapper extends AIOMapper<AInput> {
     ...
     */
    public static class Stream extends AInputMapper {
        /**
        ...
        public Stream(
            ...
            for (Path currentPath : pathInputStreamMap.keySet()) {
                ioMap.put(
                        ...
                        new AInput.Stream(pathInputStreamMap.get(currentPath), charset, fileExtension));
            }
        }
     ...
     */
    public static class File extends AInputMapper {
        /**
        ...
        public File(List<Path> paths, Path rootPath, Path mainPath, Charset charset) throws IOException {
            ...
            for (Path currentPath : paths) {
                ioMap.put(relativizeRootPath(rootPath, currentPath), new AInput.File(currentPath, charset));
            }
        }
     ...
     */
    public static class String extends AInputMapper {
        /**
        ...
        public String(
            ...
            for (Path currentPath : pathStringMap.keySet()) {
                ioMap.put(
                        relativizeRootPath(rootPath, currentPath),
                        new AInput.String(pathStringMap.get(currentPath), charset, fileExtension));
            }
        }
